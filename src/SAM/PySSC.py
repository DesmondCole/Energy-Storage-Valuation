...
class PySSC:
	def __init__(self):
		if sys.platform == 'win32' or sys.platform == 'cygwin':
			self.pdll = CDLL("C:/Users/DENDC2/Desktop/Coding/Other Projects/Energy-Storage-Valuation/src/SAM/ssc.dll") 
		elif sys.platform == 'darwin':
			self.pdll = CDLL("C:/Users/DENDC2/Desktop/Coding/Other Projects/Energy-Storage-Valuation/src/SAM/ssc.dylib") 
		elif sys.platform == 'linux2':
			self.pdll = CDLL('C:/Users/DENDC2/Desktop/Coding/Other Projects/Energy-Storage-Valuation/src/SAM/ssc.so')   # instead of relative path, require user to have on LD_LIBRARY_PATH
		else:
