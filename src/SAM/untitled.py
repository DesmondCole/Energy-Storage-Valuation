...
if __name__ == "__main__":
	ssc = PySSC()
	print ('Current folder = C:/Users/DENDC2/Desktop/Coding/Other Projects/Energy-Storage-Valuation/src/SAM')
	...
	ssc.data_set_number( data, b'system_capacity', 4.6928696632385254 )
	...
	ssc.data_set_number( data, b'subarray1_nstrings', 2 )
	...
	ssc.data_set_number( data, b'subarray1_gcr', 0.30000001192092896 )
	...
	ssc.data_set_number( data, b'cec_area', 1.6310000419616699 )
	...
	ssc.data_set_number( data, b'sd11par_AMa0', 0.94169998168945313 )
	...
	ssc.data_set_number( data, b'sd11par_Imp0', 1.0500000715255737 )
	ssc.data_set_number( data, b'sd11par_Voc0', 87 )
	ssc.data_set_number( data, b'sd11par_Isc0', 1.1799999475479126 )
	ssc.data_set_number( data, b'sd11par_alphaIsc', 0.00047200100379996002 )
	ssc.data_set_number( data, b'sd11par_n', 1.4507100582122803 )
	ssc.data_set_number( data, b'sd11par_Il', 1.1895099878311157 )
	ssc.data_set_number( data, b'sd11par_Io', 2.0852199966725493e-09 )
	...
	ssc.data_set_number( data, b'mppt_low_inverter', 250 )
	ssc.data_set_number( data, b'mppt_hi_inverter', 480 )
	ssc.data_set_number( data, b'inv_num_mppt', 1 )
	ssc.data_set_number( data, b'inv_snl_c0', -3.1800000215298496e-06 )
	ssc.data_set_number( data, b'inv_snl_c1', -5.1200000598328188e-05 )
	ssc.data_set_number( data, b'inv_snl_c2', 0.00098400004208087921 )
	ssc.data_set_number( data, b'inv_snl_c3', -0.0015099999727681279 )
	ssc.data_set_number( data, b'inv_snl_paco', 3800 )
	ssc.data_set_number( data, b'inv_snl_pdco', 3928.1142578125 )
	ssc.data_set_number( data, b'inv_snl_pnt', 0.99000000953674316 )
	ssc.data_set_number( data, b'inv_snl_pso', 19.451622009277344 )
	ssc.data_set_number( data, b'inv_snl_vdco', 398.49667358398438 )
	ssc.data_set_number( data, b'inv_snl_vdcmax', 600 )
	ssc.data_set_number( data, b'inv_cec_cg_c0', -3.1751999358675675e-06 )
	ssc.data_set_number( data, b'inv_cec_cg_c1', -5.1231399993412197e-05 )
	ssc.data_set_number( data, b'inv_cec_cg_c2', 0.00098359596449881792 )
	ssc.data_set_number( data, b'inv_cec_cg_c3', -0.0015077999560162425 )
	ssc.data_set_number( data, b'inv_cec_cg_paco', 3800 )
	ssc.data_set_number( data, b'inv_cec_cg_pdco', 3928.110107421875 )
	ssc.data_set_number( data, b'inv_cec_cg_pnt', 0.99000000953674316 )
	ssc.data_set_number( data, b'inv_cec_cg_psco', 19.448400497436523 )
	ssc.data_set_number( data, b'inv_cec_cg_vdco', 398.49700927734375 )
	...
	inv_tdc_cec_cg = [[ 1,   52.799999237060547,   -0.020999999716877937 ]];
	ssc.data_set_matrix( data, b'inv_tdc_cec_cg', inv_tdc_cec_cg );
	inv_tdc_ds = [[ 1,   52.799999237060547,   -0.020999999716877937 ]];
	ssc.data_set_matrix( data, b'inv_tdc_ds', inv_tdc_ds );
	inv_tdc_plc = [[ 1,   52.799999237060547,   -0.020999999716877937 ]];
	...
	ssc.data_set_array_from_csv( data, b'dc_adjust:hourly', b'C:/Users/DENDC2/Desktop/Coding/Other Projects/Energy-Storage-Valuation/src/SAM/dc_adjust_hourly.csv');
	dc_adjust_periods = [[ 0,   0,   0 ]];
	ssc.data_set_matrix( data, b'dc_adjust:periods', dc_adjust_periods );
	ssc.data_set_number( data, b'inv_snl_eff_cec', 96.636932373046875 )
